<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=blur&color=auto&height=260&section=header&text=Hi%20I'm%20Jisoo%20Lee&fontSize=55&fontColor=ffffff&animation=fadeIn&stroke=ffffff&strokeWidth=20" width="100%" />
</p>
...
### 📑 Publications
* **IEEE ICTC 2025 (First Author & Oral Presenter)**
...
* **Wireless Swarm Autonomous Driving System (Graduation Project)**
  ...
  * Integrating **IMU and Odometry** data for high-accuracy localization, combined with **Camera-based YOLOv5** object recognition for real-time tracking and obstacle avoidance.
  * Containerized the development environment using **Docker** to ensure cross-platform reproducibility.
* **Global AI Healthcare Capstone Project (Cebu, Philippines)**
  * Developed a smart rehabilitation device for stroke patients using tactile sensors and electromagnets.
  * Won the **Grand Prize (대상)**.
